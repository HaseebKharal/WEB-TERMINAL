...
if(ricetype=="White Rice" && bagtype=="3")
{
...
if(ricetype=="Steam Rice" && bagtype=="1")
{
   price = 1600
}
if(ricetype=="Steam Rice" && bagtype=="2")
{
   price = 3200
}
...
if(ricetype == "Crop Seed" && bagtype=="1")
{
  price = 800
}
if(ricetype == "Crop Seed" && bagtype=="2")
{
  price = 1600
}
if(ricetype == "Crop Seed" && bagtype=="3")
{
  price = 4000
}
if(ricetype == "Fertilizer" && bagtype=="1")
{
  price = 880
}
if(ricetype == "Fertilizer" && bagtype=="2")
{
  price = 1760
}
if(ricetype == "Fertilizer" && bagtype=="3")
{
  price = 4400
}
if(ricetype == "Wheat" && bagtype=="1")
{
  price = 500
}
if(ricetype == "Wheat" && bagtype=="2")
{
  price = 1000
}
if(ricetype == "Wheat" && bagtype=="3")
{
  price = 2500
}
if(ricetype == "Crop Medicen" && bagtype=="1")
{
  price = 1500
}
if(ricetype == "Crop Medicen" && bagtype=="2")
{
  price = 3000
}
if(ricetype == "Crop Medicen" && bagtype=="3")
{
  price = 7500
}
...
FireBAse.database().ref('Inventory').push(buyingform)
...
<a className="navbar-brand" href="#" style={{color:'white',fontSize:25,fontWeight:'bold'}}><Link to="/KharalTrading/" style={{textDecoration:'none',color:'white'}}>Kharal Trading Rice</Link></a>
        <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" onClick={()=>{history.push({pathname:"/KharalTrading/"})}}>
        ...
        <form>
            ...
            <div className="mb-3">
             ...
             <div className="row mb-3">
              ...
              <div className="row mb-3">
                <div className="col-md-4 themed-grid-col">Price of Wheat</div>
                <div className="col-md-4 themed-grid-col">50 kg</div>
